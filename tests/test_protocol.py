...
class ProtocolTests(unittest.TestCase):
 ...
 def test_calibrate_has_no_parameters(self):
  self.assertEqual(parse_request(req('calibrate'))['operation'],'calibrate')
  with self.assertRaises(ProtocolError):parse_request(req('calibrate',{'device':1}))
